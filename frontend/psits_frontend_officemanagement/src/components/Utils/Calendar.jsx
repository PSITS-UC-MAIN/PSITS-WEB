        ...
        <div className="days">
            <div className="day mon">
                ...
                <div className="events">
                    {
                        day_5_result.map((log)=> <ProfileLog key={log.id} fullname={log.fullname} loginTime={log.loginTime} logoutTime={log.logoutTime} purpose={log.remarks} imageSource={'https://avatars.githubusercontent.com/u/72720429?s=256&v=4'}/>)
                    }
                </div>
            </div>
            <div className="day tues">
                ...
                <div className="events">
                    {
                        day_4_result.map((log)=> <ProfileLog key={log.id} fullname={log.fullname} loginTime={log.loginTime} logoutTime={log.logoutTime} purpose={log.remarks} imageSource={'https://avatars.githubusercontent.com/u/72720429?s=256&v=4'}/>)
                    }
                </div>
            </div>
            <div className="day wed">
                ...
                <div className="events">
                    {
                        day_3_result.map((log)=> <ProfileLog key={log.id} fullname={log.fullname} loginTime={log.loginTime} logoutTime={log.logoutTime} purpose={log.remarks} imageSource={'https://avatars.githubusercontent.com/u/72720429?s=256&v=4'}/>)
                    }
                </div>
            </div>
            <div className="day thurs">
                ...
                <div className="events">
                    {
                        day_2_result.map((log)=> <ProfileLog key={log.id} fullname={log.fullname} loginTime={log.loginTime} logoutTime={log.logoutTime} purpose={log.remarks} imageSource={'https://avatars.githubusercontent.com/u/72720429?s=256&v=4'}/>)
                    }
                </div>
            </div>
            <div className="day fri">
                ...
                <div className="events">
                    {
                        day_1_result.map((log)=> <ProfileLog key={log.id} fullname={log.fullname} loginTime={log.loginTime} logoutTime={log.logoutTime} purpose={log.remarks} imageSource={'https://avatars.githubusercontent.com/u/72720429?s=256&v=4'}/>)
                    }
                </div>
            </div>
        </div>
