    ...
    <div className='w-[60%]'>
      {
          ...
          <Card className='w-full'>
            ...
            <CardFooter className='w-full flex items-center justify-between'>
                ...
                <div className='flex items-center gap-4'>
                  <Button variant="ghost" onClick={() => setAnnounceState(false)}> Cancel </Button>
        ...
        (
          <div onClick={() => setAnnounceState(true)} className='mb-4 w-full border rounded shadow p-6 cursor-pointer flex items-center gap-4'>
            <Avatar>
