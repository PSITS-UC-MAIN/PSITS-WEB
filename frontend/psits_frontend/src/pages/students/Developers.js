...
const Developers = () => {
    return (_jsx(Wrapper, { title: "PSTIS | Officers", children: _jsxs("div", { className: "m-20", children: [_jsx("h1", { className: "text-4xl font-medium mb-4 text-[#074873]", children: "DEVELOPERS" }), _jsx("div", { className: "flex gap-4 flex-wrap justify-center", children: dummyData.map((data) => {
