    ...
    <Wrapper noMargin title='PSITS | About Us'>
        <div className="mt-10 mx-20 rounded">
            ...
            {aboutBannerImages.map((slideImage)=> (
                <div key={slideImage.name} className='flex items-center justify-center rounded h-[500px] bg-contain bg-no-repeat bg-center' style={{'backgroundImage': `url(${slideImage.banner})`}} />
            ))} 
            </Slide>
        </div>
