            ...
            <CardContent>
              <div className="flex flex-col gap-y-10">
                ...
                <p className="word-break">
                  The University offers affordable and quality education responsive to the demands of local and
            ...
            <CardContent>
              <div className="flex flex-col gap-y-10 p-5">
                ...
                <p className="word-break text-xs">
                  We envision being the hub of quality, globally-competitive and socially-responsive information
            ...
            <CardContent>
              <div className="flex flex-col gap-y-10 p-5">
                ...
                <p className="word-break text-xs text-start">
                  ...
                  <br />
                  <br />
                  Promotes scholarly endeavors for the promotion of moral, social, cultural, and environmental
                  interests;
                  <br />
                  <br />
