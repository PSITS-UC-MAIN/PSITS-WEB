...
const User = require('../classesDTO/User');
const Announcement = require('../classesDTO/Announcement');
...
function GenerateReference(){
    return `PSITS_${GenerateRandom(10000000,99999999)}${GenerateRandomLetter()}${GenerateRandom(1000,9999)}${GenerateRandomLetter()}${GenerateRandomLetter()}${GenerateRandomLetter()}`
}
